...
<body>
    ...
    <script>
        ...
        let clothesScore = localStorage.getItem('clothesScore') ? parseInt(localStorage.getItem('clothesScore')) : 0;
        ...
        function check(element, answer, choiceValue, num) {
            ...
            if (answer == choiceValue) {
                ...
                localStorage.setItem('clothesScore', clothesScore);
        ...
        function showScore() {
            Swal.fire({
                icon: "info",
                title: "퀴즈 종료",
                text: `최종 점수는 ${clothesScore}점 입니다!`,
                showConfirmButton: true
            }).then(() => {
                // 결과 페이지로 이동
                location.href = "result_page.php?score=" + clothesScore; // 점수를 result_page.php에 전달

                localStorage.removeItem('clothesScore');
            });
        }
