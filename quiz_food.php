...
<body>
    ...
    <main>
        <div class='content_container'>
            <div class='inner_container'>
                ...
                if ($rnd == 45 || $rnd == 47 || $rnd == 49 || $rnd == 52 || $rnd == 53 || $rnd == 55) {
                    echo "
                    ...
                    echo "
                    <h2 class='question_number'>$qNum/20</h2>
    ...
    <script>
        ...
        let foodScore = localStorage.getItem('foodScore') ? parseInt(localStorage.getItem('foodScore')) : 0;
        ...
        function check(element, answer, choiceValue, num) {
            ...
            if (answer == choiceValue) {
                ...
                localStorage.setItem('foodScore', foodScore);
        ...
        function showScore() {
            Swal.fire({
                icon: "info",
                title: "퀴즈 종료",
                text: `최종 점수는 ${foodScore}점 입니다!`,
                showConfirmButton: true
            }).then(() => {
                // 결과 페이지로 이동
                location.href = "result_page.php?score=" + foodScore; // 점수를 result_page.php에 전달

                localStorage.removeItem('foodScore');
            });
        }
