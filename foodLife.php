                    ...
                    if ($rnd == 45 || $rnd == 47 || $rnd == 49 || $rnd == 52 || $rnd == 53 || $rnd == 55) {
                        ...
                        <div class='carousel-item $isActive'>
                           ...
                           <div class='d-flex justify-content-between'>
                                <div class='m-auto w-50'><img src='../sign/{$rnd}1.jpg' class='d-block ' alt='{$row['answer']}'></div>
                                <div class='m-auto w-50'><img src='../sign/{$rnd}2.jpg' class='d-block ' alt='{$row['answer']}'></div>
                           </div>
